...
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
	\item Created a Kijiji-like web app where tutors can market their services and students can meet verified safe tutors. This tutoring brokerage website was developed in Python using the Django framework.  
	...
	\item Having launched with 30 tutors exclusively in London, Tutor Hero grew to 1600 tutors across 17 cities in Canada in six months. www.tutorhero.ca
\end{itemize}
